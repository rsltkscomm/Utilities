...
public class NewSummaryReportGenerator
{
	...
	public static AggregatedStats aggregateStats()
	{
        ...
        for (TestExecution exec : DetailedTestReporter.getReport().getTestExecutions())
		{
			...
			{
				case PASS:
					agg.totalPass++; mod.passed++; break;
				case FAIL:
					agg.totalFail++; mod.failed++; break;
				case SKIPPED:
					agg.totalSkip++; mod.skipped++; break;
			}
			try {
	...
	public static String getReportHtml(String productName, int pass, int fail, int noRun, int total, String duration,
	    ...
	    return String.format(
	        ...
	        System.getProperty("user.name"), startTime, pass, fail, noRun, total, 
	        detailedReportContent, moduleDataJson, pass, fail, noRun);
	}
