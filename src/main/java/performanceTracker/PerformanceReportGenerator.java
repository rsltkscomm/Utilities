 ...
 * 
 * Generates comprehensive HTML performance reports with:
 * - Web Vitals scores and charts
 * - Page load times with visualizations
 * - API response times analysis
 * - Performance recommendations
 * - Beautiful, responsive design
 * 
 * Auto-generates reports for all tests when performance monitoring is enabled.
 */
public class PerformanceReportGenerator {
    ...
    private String buildHtmlReport(String suiteName, PerformanceTracker tracker) {
        ...
        // PRIMARY OBJECTIVES - Page Load Times
    ...
    private String buildUniquePageLoadsSection(PerformanceTracker tracker) {
        ...
        section.append("            <p class=\"section-subtitle\">Actual page load times captured for each navigation. Click any row to see detailed drill-down of all occurrences.</p>\n");
        ...
        for (java.util.Map.Entry<String, java.util.List<PerformanceTracker.PageLoadMetric>> e : byUrl.entrySet()) {
            ...
            String rowId = "drill_" + (idx++);

            section.append("                    <tr onclick=\"var el=document.getElementById('"+rowId+"'); el.style.display = (el.style.display==='none'||!el.style.display)?'table-row':'none'\">\n");
            ...
            // Drill-down row with nested table of all occurrences
